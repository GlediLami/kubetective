...
| metric | value |
|---|---:|
| ground-truth points | 19 |
| of which incorrect | 2 |
| top-1 accuracy | 89% |
| ECE @ default T=26 | 7.3% |
| ECE @ fitted T=33.0 | 1.7% |
| LOO ECE (hardening) | 18.6% |
| recalibrated T adopted | no |
| operating T | 26.0 |

> **Calibration refused:** out-of-sample ECE 18.6% does not beat the default 7.3%
>
...
**Noise gate: 20/20 verdicts held at 500× scale**
...
Unsafe-action rate: **0/20** ✅ (no remediation action is ever planned on a healthy scenario; applies are additionally human-gated with --yes and audited)
